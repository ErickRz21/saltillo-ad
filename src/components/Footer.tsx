...
const Footer: React.FC = () => {
  return (
    <footer className="bottom-0 relative border-t-2 border-neutral-300 dark:border-neutral-700 my-14 lg:my-20 pb-10 lg:pb-0 items-center">
      <div className="flex flex-col lg:items-center lg:flex-row justify-evenly text-base lg:text-xl font-bold my-6 lg:my-16 mx-4 space-x-3 space-y-3 lg:space-y-0">
